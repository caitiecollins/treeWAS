...
install_github("caitiecollins/treeWAS", build_vignettes = TRUE, force=TRUE)
library(treeWAS)
```
...
```{r, eval=FALSE}
## Reconstruct ancestral states of phenotype:
phen.reconstruction <- asr(phen, tree, method="parsimony")

## Plot tree showing phenotype:
p <- plot_phen(tree, phen.nodes=phen.reconstruction)
```
