...
(&\frac{4}{3}(p_i^{anc}s_i^{anc})\ +\ \frac{2}{3}(p_i^{anc}s_i^{des})\ +\ \\
& \frac{2}{3}(p_i^{des}s_i^{anc})\ +\ \frac{4}{3}(p_i^{des}s_i^{des})\ -\ \\
& p_i^{anc}\ -\ p_i^{des}\ -\ s_i^{anc}\ -\ s_i^{des}\ +\ 1)\ |
\end{align}
$$
...
### Example with Data Simulated by *treeWAS*
<!-- ########################################################################################################## -->

To Do: Run one of these examples throughout the vignette instead. 

### Example with Data from ClonalFrameML
<!-- ########################################################################################################## -->
