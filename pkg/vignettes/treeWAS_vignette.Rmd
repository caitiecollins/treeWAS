...
> By default, `phen.type` is `NULL`, in which case ML reconstructions will be `"discrete"` 
> for any phenotypes that are less than 25% unique and `"continuous"` for phenotype more than 25% unique. 
